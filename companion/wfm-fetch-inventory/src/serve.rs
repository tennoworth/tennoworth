//! `serve` subcommand — loopback HTTP server the web UI uses to bulk-create
//! warframe.market listings. We hold the decrypted JWT in memory for the
//! process lifetime; the browser never sees it.
//!
//! Trust:
