...
<div data-shell class={showWorkspace ? 'shell' : 'desktop-landing'}>
  ...
  <footer data-shell class="sitefoot">
    ...
    {:else if effectiveView === 'settings'}
      <SettingsPanel onwhatsnew={() => updateNotesRef?.open()} {theme} {transport} {autoScan} {isDesktop} wfmStatus={listing.wfmStatus} onwfmlogout={() => listing.handleWfmLogout()} />
    {/if}
