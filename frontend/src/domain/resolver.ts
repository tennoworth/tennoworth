...
import type { Market, ResolvedItem, SlimItemInfo } from '../contracts/data';
...
// rust/tennoworth-desktop/src/services/sellables.rs's slug_guess(); both are
...
// rust/tennoworth-desktop/src/services/sellables.rs's path_name_guess(); both
...
// rust/wfm-core/src/trading/listing.rs has a matching lowercase fixture
