...
import { createStateStore, LocalStorageStateStore, TauriStateStore, LOCAL_SETTING_KEYS } from './state-store';
...
describe('LocalStorageStateStore - key/shape parity with the pre-store code', () => {
  ...
  const CASES = [
    ...
    ['routine-checklist', 'wfminv:routine-checklist-v1', '{"version":1}'],
