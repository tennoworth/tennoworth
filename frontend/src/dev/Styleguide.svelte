...
<main class="styleguide ui-stack">
  ...
  <section class="wrap tw" aria-labelledby="table-title">
    ...
    {:else if dataState === 'error'}
      <div class="specimens ui-stack"><div class="ui-toolbar"><strong>Using saved scan</strong><time datetime="2026-09-08T12:00:00Z">As of 8 September 2026, 12:00 UTC · 2d ago</time><span class="bad">Last refresh failed</span></div><p class="ui-notice" data-tone="bad" role="alert">Inventory could not be refreshed. Saved items remain available.</p><div><button class="btn" onclick={() => dataState = 'populated'}>Retry sample load</button></div></div>
