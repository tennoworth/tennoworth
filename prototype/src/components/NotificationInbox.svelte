<script lang="ts">
  ...
  import { desktopNotifications, desktopReadNotifications, desktopClearNotifications, NOTIFICATIONS_EVENT, type NotificationEntry, type NotificationTarget } from '../lib/transport';
