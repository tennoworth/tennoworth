<script lang="ts">
  ...
  import { computeResults } from '../lib/filter-engine';
  import { SESSION_MODES, selectSession, type SessionMode, type SessionRow } from '../lib/trade-session';
  import { desktopTradeSessionState, desktopLiveTopPrices, ALLOWANCE_CHANGED_EVENT } from '../lib/transport';
  import { listenForTauriEvent } from '../lib/desktop-update';
  import { humanError } from '../lib/errors';
  import { MAX_PLAN_ITEMS } from '../lib/limits';
  import { cachedUnitMarket } from '../lib/order-prices';
  import type { Market, MarketItemEntry, OwnedRecord, TradeSessionState } from '../lib/types';
