...
import { NOTIFICATIONS_EVENT, MARKET_REFRESHED_EVENT, NOTIFICATION_CATEGORIES } from './transport';
import { vaultAffects } from './calendar-feed';
...
import { affecting, buildCalendar } from './calendar-feed';
