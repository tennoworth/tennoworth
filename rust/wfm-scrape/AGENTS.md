...
and complete, and `scripts/archive-observations.sh` copies it off the box with a
verified manifest. The check answers collection-readiness only; the schedule
decision belongs to `replay`.
