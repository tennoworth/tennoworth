...
before compiling the app: Cargo embeds that bundle. The
[architecture guide](../docs/architecture.md) maps native services, persistence,
capture, and pipeline stages.
