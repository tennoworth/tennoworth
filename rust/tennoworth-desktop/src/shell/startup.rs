...
pub(crate) fn run() {
    ...
    tauri::Builder::default()
        ...
        .plugin(tauri_plugin_single_instance::init(|app, _argv, _cwd| {
            crate::shell::tray::show_main_window(app);
        }))
        ...
        .plugin(tauri_plugin_global_shortcut::Builder::new()
            ...
            .build())
        .manage(crate::shell::tray::TrayState::default())
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            crate::shell::probe::debug_write_login,
            crate::shell::probe::debug_seed_unlocked,
            crate::shell::probe::debug_post_scan,
            crate::shell::probe::probe_report,
            crate::shell::probe::probe_exit
        ])
        .setup(move |app| {
            ...
            w.on_window_event(move |event| {
                if let tauri::WindowEvent::CloseRequested { api, .. } = event {
                    ...
                    {
                        let _ = app_for_hint.emit(crate::shell::tray::EVENT_TRAY_HINT, ());
                    }
                }
            });
            ...
            if let Err(e) = crate::shell::tray::init_tray(&app.handle().clone()) {
            ...
            tauri::async_runtime::spawn(async move {
                crate::shell::update::check_and_emit(&update_handle).await;
            });
